...
news=new Array()
news[0]=new Array()
news[0]["text"]="<font face=verdana size=2>Welcome to our newest member <b><?php echo $username; ?></b>."
news[0]["link"]="members.php?do=profile&member=<?php echo $id; ?>"

news[1]=new Array()
news[1]["text"]="<font face=verdana size=2><b>Current news</b> : <?php echo $news; ?>."
news[1]["link"]="#"

news[2]=new Array()
news[2]["text"]="<font face=verdana size=2>There are currently <b><?php echo $numusers; ?></b> registered members."
news[2]["link"]="members.php?"

news[3]=new Array()
news[3]["text"]="<font face=verdana size=2>There are currently <b><?php echo $posts; ?></b> posts in <b><?php echo $topics; ?></b> topics."
...
<div id="divCont" >
	<div id="divNews">
		...
		if(document.all || document.layers) document.write("<font face='" + FontFace + "' size='" + FontSize + "'><b>Current news</b> : <?php echo $news; ?>.<br><a href='members.php?do=profile&member=<?php echo $id; ?>'>Welcome to our newest member <b><?php echo $username; ?></b>.</a></font>")
		</script>
	</div>
</div>
