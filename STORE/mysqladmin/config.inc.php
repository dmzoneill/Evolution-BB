...
$cfgServers[1]['stduser']       = 'evobb';          // MySQL standard user settings (this user must have read-only
$cfgServers[1]['stdpass']       = 'chickenballssmell';          //   access to the "mysql/user" and "mysql/db" tables)
$cfgServers[1]['adv_auth']      = FALSE;       // Use advanced authentication?
$cfgServers[1]['user']          = 'evobb';      // MySQL user
$cfgServers[1]['password']      = 'chickenballssmell';          // MySQL password (only needed with basic auth)
