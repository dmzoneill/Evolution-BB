...
// Filename: style.php
// Description: Implements the Style class which controls alot of the way
// 				 html is displayed and outputted around the board.
...
class Style {
   ...
   function Style() {
      ...
      // As soon as the css is complete, all of this crap will be
      // gone. It will speed things up alittle.
   ...
   function ForumHeader() {
      ...
      if($loggedin)  {
         ...
         <a href="inbox.php"><img src="<?php echo $iconsrc; ?>" alt="<?php echo $iconalt; ?>" border="0"/></a>
         <?php echo $messages; ?><br/>
         <a href="prefs.php"><img border="0" src="images/cp.gif" alt="Control Panel"/>Control Panel</a><br/>
         <a href="logout.php"><img border="0" src="images/exit.gif" alt="Logout"/>Logout</a>
         <?php
      	if(getrank($userid)>3) {
	      	?><br/><a href="./admin/"><img src="images/admin.gif" border="0" alt="Administrator Panel"/>Administration Panel</a>
            <?php
         }
         ?>                                        
         </p>
			...
			<?php
     	 	...
     	 	or <a href="members.php?do=signup">register</a> for free.</p>
         ...
         <tr> 
         <td class="StatsPortionMenuHeader">Who's Online</td>
         </tr>
         <tr> 
         <td class="StatsInfoContent"><p><br />
         <?php include("whos.php"); ?>
         <br />
         </p></td>
         </tr>
         <tr> 
         ...
         Most Posts: <a href="members.php?do=profile&member=<?php echo $members[mostPostsId]; ?>" class="StatsLink"><?php echo $members[mostPostsName]; ?></a> <?php echo "(".$members[mostPostsPosts].")"; ?></p>
