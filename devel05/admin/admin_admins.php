...
switch($parse) {
        ...
        case "view":
                ...
                echo "<span class=maintext>Click on a users name, to strip administrative status<br><br>";

                $admins = $stream->do_query("select id, username from evo_users where rank = '5' order by username ASC", "array");
