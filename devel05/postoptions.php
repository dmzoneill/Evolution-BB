...
if((!$groupid) || (!$forumid) || (!$topicid) || (!$postid))
     dead($language[postopt]);
        ...
        if($hppp=="0"){
                ...
                $homepagep = "<a target='_blank' href=\"$hppp\"><img src=images/www.gif border=0></a>&nbsp;";
        }
        ...
        if($info=="0"){
                ...
                $msnm = "<a target='_blank' href='members.php?do=profile&member=$posterid'><img src=images/msn.gif border=0 alt=\"$info\"></a>&nbsp;";
        }
        unset($info);
        ...
        if($info=="" || $testemail==0 || $testemail=="0"){
                ...
                $email = "<a target='_blank' href=\"members.php?do=contact&member=$posterid\"><img src=images/email.gif border=0 alt=\"Email:  $info\"></a>&nbsp;";
        }
        unset($info);
        ...
        if($info=="0"){
                ...
                $icq = "<a target='_blank' href=\"members.php?do=contact&member=$posterid\"><img src=images/icq.gif border=0 alt=\"Page: $info\"></a>&nbsp;";
        }
        unset($info);
        ...
        if($info==""){
                ...
                $aim = "<a target='_blank' href=\"members.php?do=profile&member=$posterid\"><img src=images/aim.gif border=0 alt=\"$info\"></a>&nbsp;";
        }
        unset($info);
                /* Get Users info */
        unset($homepagep);
       ...
       if(mod_auth($userid, $forumid, $groupid)==1) {
                ...
                ?>
                <a target='_blank' href="award.php?aid=<?php echo $posterid;?>&forumid=<?php echo $forumid;?>&topicid=<?php echo $topicid;?>"><img src="images/vote.gif" border=0></a><br>
                <?
