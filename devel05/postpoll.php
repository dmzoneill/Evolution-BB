...
<?php $style->textout($language[newtopicdone] ."<br><a href=\"$shit?groupid=$groupid&forumid=$forumid&topicid=$topicid'\">$language[clickhere]</a>"); ?>
...
<td bgcolor="<?php echo $style->tbl1color; ?>"><input type=submit value="<?php echo $language[yes]; ?>" name=tryagain><input type=hidden name=step value="maketopic"><input type=hidden name=post value="<?php echo rawurlencode(stripslashes($post));?>"><input type=hidden name=postsub value="<?php echo rawurlencode(stripslashes($postsub));?>"><input type=hidden name=attachment value="<?php echo strtolower($fupload_name);?>"></td>
...
<form  enctype='multipart/form-data' method=post action="<?php echo $PHP_SELF;?>?threaded=<?php echo $threaded;?>" name="evobb">
