...
echo "<center><br>".$style->textout("$language[message] $language[sent].")."<br></center>";
...
<td><?php echo $style->textout("<b>$language[to]:</b> <input type=hidden name=hash value=\"$hash\">$name - <a href=\"chat/index.php?towho=$hash\">$language[chatinvite]</a>");?><br>
