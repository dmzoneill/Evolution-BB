...
<th bgcolor="<?php echo $style->tbl_header; ?>"><?php $style->headertextout($language[movetopic]); ?></th>
...
<?php $style->textout($language[wheretopic]); ?>
...
<br><input type=submit name=move value="<?php echo $language[movetopic]; ?>!">
...
<td align=center bgcolor="<?php echo $style->tbl1color; ?>"><?php $style->textout($language[successmoved]); ?></td>
