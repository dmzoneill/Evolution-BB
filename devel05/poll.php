...
<input type=submit value="<?php echo $language[add]; ?>">
...
$tbl = "
<tr>
<th colspan=3 bgcolor=\"$style->tbl_header\"><font face=\"$style->face\" color=\"$font_color\" size=\"$style->size\">$language[poll] $name</font></th>
</tr>
<tr>
<th width=48% bgcolor=\"$style->tbl_header\"><font face=\"$style->face\" size=\"$style->size\">$language[choice]</font></th>
<th width=50% bgcolor=\"$style->tbl_header\"><font face=\"$style->face\" size=\"$style->size\">$language[stats]</font></th>
<th width=2% bgcolor=\"$style->tbl_header\"><font face=\"$style->face\" size=\"$style->size\">$language[Vote]</font></th>
</tr>
";
...
$sql = $stream->do_query("update evo_poll set '$choice' = '$num', voted = '$voted' where auto = '$poll'", "one");
...
<table border=0 width=100% cellspacing=1 cellpadding=4>
<tr>
<th bgcolor="<?php echo $style->tbl_header; ?>" colspan=2 align=center><?php $style->headertextout($language[Voteadded]); ?>
...
<tr>
<td bgcolor="<?php echo $style->tbl1color; ?>" colspan=2 align=center><?php $style->textout($language[vadded]); ?></td>
</tr>
</table>
</td></tr></table><br>
<?
