...
<a href="<?php if ($threaded<1){echo "viewtopic.php";} else {echo "threadedview.php";}?><?php echo "?groupid=$groupid&forumid=$forumid&topicid=$topicid&postid=$postid";?>"><?php $style->textout("Click here to view it!");?></a>
