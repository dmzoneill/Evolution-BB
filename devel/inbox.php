...
if(!$do){
  ...
  $message = ereg_replace("--------------------------------------------------", "<hr width=100% noshade>", $message);
  $unique=uniqid(0);
  ...
  <td bgcolor="<?php echo $style->tbl1color; ?>"><?php $style->textout(nl2br(wordfilter(stripslashes(rawurldecode($message))))); ?></td></tr>
  </tr>
  </table>
  </td></tr></table><br>
  <?
