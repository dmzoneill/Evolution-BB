...
$array = explode("|", tpcount()); $users=$array[0]; $topics=$array[1]; $posts=$array[2]; 
...
<br>
<center>
<table width=\"$this->tbl_width\" border=\"0\">
<tr><td>
";
$this->textout("<b>Total users:</b> ". $users ." <b>Total Topics:</b>: " .$topics ." <b>Total Posts: </b>" .$posts) ;
?>
<br />
</td></tr></table><br />
<?
