...
if ($loggedin){
    ...
    $ip = getenv("REMOTE_ADDR");
        ...
        $sql1 = $stream->do_query("INSERT INTO evo_posts_$forumid (topic_id, post_id, poster_id, post, time, something, ip, subject, parent) VALUES ('$topicid', '', '$userid', '$post', '$time', '', '$ip', '$thesubject', '$postid')", "one");
...
<td bgcolor="<?php echo $style->tbl1color; ?>"><input type=submit value="<?php echo $language[reply]; ?>">&nbsp;<input type=reset value="Reset"></td>
