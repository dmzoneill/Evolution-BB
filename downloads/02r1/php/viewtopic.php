...
for ($i=$poststart; $i<$postend; $i++){
        ...
        if(mod_auth($userid, $forumid, $groupid)==1) {
                ...
                <a href="#" onMouseDown="javascript:alert('Posted with the IP Address: <?php echo $ip; ?>')"><img src="images/ip.gif" border=0></a>&nbsp;<a href="deletepost.php?forumid=<?php echo $forumid; ?>&topicid=<?php echo $topicid; ?>&groupid=<?php echo $groupid; ?>&postid=<?php echo $_thispost_id; ?>"><img src=images/delete_topic.gif border=0></a>
                <?
        }
        ?>
		<br>
...
<!--
<br><a href=reply.php?forumid=<?php echo $forumid; ?>&groupid=<?php echo $groupid; ?>&topicid=<?php echo $topicid; ?>&quote=<?php echo $_thispost_id; ?>> <img src="images/quote_reply.gif" alt="Quote" border=0></a>
-->
